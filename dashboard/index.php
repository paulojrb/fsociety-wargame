...
* for create user
* ------------------------------------------*/
if ( isset($_SESSION["insert_flag"]) ) {
    $msg = $_SESSION["insert_flag"]["msg"];

    switch ($_SESSION["insert_flag"]["error"]) {
        case 'A1':
            echo "
            <script>
            window.onload = function(){
...
<body style="background-color: #1b203d !important; font-family:Nunito ">
				...
				<nav class="uk-navbar uk-navbar-container uk-navbar-transparent" data-uk-navbar style="margin-top: 20px;">
					...
					<div class="uk-navbar-right">
						<ul class="uk-navbar-nav uk-visible@s">
							...
							<li><a href="#modal-edit-pictures" data-uk-toggle><img src="../img/profile/<?php echo $_SESSION["img_profile"]; ?>" width="50" height="50" uk-svg></a></li>
						</ul>
    ...
    <aside id="left-col" class="uk-light uk-visible@m">
        ...
        <div class="left-nav-wrap">
            <ul class="uk-nav uk-nav-default uk-nav-parent-icon" data-uk-nav>
                ...
                <li><a href="#get-flag" data-uk-toggle><span data-uk-icon="icon: unlock" class="uk-margin-small-right"></span>Resgatar Flag</a></li>
                <li class="uk-parent">
        ...
        <div class="uk-container uk-container-expand" style="background-color: #1b203d;">
            <div  style="margin-top: 60px;">
                <ul uk-tab>
                    ...
                    <li><a href="#">Pergunta Surpresa</a></li>
                    <li><a href="#">Item</a></li>
                </ul>
                ...
                <ul class="uk-switcher uk-margin">
                    ...
                    <li>
                        <div class="uk-flex uk-flex-center">
                            <div class="uk-card uk-card-default uk-card-body">Qual dessas consultas seria mais indicado para testar uma vulnerabilidade de Cross-Site Scripting?</div>
                        </div>
                        <div class="uk-flex uk-flex-center">
                        <div class="uk-flex uk-flex-column ">
                            <div class="uk-card uk-card-default uk-card-body"><label><input class="uk-radio" type="radio" name="radio2" checked> &lt;script&gt;alert(1)&lt;/script&gt;</label></div>
                            <div class="uk-card uk-card-default uk-card-body"><label><input class="uk-radio" type="radio" name="radio2"> B</label> &lt;script&gt;alert(1)&lt;/script&gt;</div>
                            <div class="uk-card uk-card-default uk-card-body"><label><input class="uk-radio" type="radio" name="radio2"> C</label> &lt;script&gt;alert(1)&lt;/script&gt;</div>
    ...
    <div id="menu-nav" data-uk-offcanvas="flip: true; overlay: false">
        <div class="uk-offcanvas-bar uk-offcanvas-bar-animation uk-offcanvas-slide">
            ...
            <ul class="uk-nav uk-nav-default">
                <ul class="uk-nav uk-nav-default uk-nav-parent-icon" data-uk-nav>
                    <li class="uk-navbar-header"><span style="font-family: Handlee">Menu</span></li>
                    <li><a href="../">Voltar</a></li>
                    <li><a href="../php/logoff.php">Sair</a></li>
                    <li><a href="#modal-edit-pictures" data-uk-toggle>Mudar foto</a></li>
                    <li class="uk-nav-header" ><span style="font-family: Handlee">main</span></li>
                    <li><a href="#"><span data-uk-icon="icon: comments" class="uk-margin-small-right"></span style="color: white;">Messages</a></li>
                    <li><a href="#"><span data-uk-icon="icon: users" class="uk-margin-small-right"></span>Friends</a></li>
    ...
    <div id='get-flag' data-uk-offcanvas='flip: true; overlay: false'>
        <div class='uk-offcanvas-bar uk-offcanvas-bar-animation uk-offcanvas-slide'>
            <button class='uk-offcanvas-close uk-close uk-icon' type='button' data-uk-close></button>
            <br>
            ...
            <div id='ResgatarFlag'>
                ...
                <form action='../php/get-flag.php' method='POST'>
                    ...
                    <button type='submit' class='uk-button uk-button-default'>Resgatar</button>
                </form>
            </div>
        </div>
    </div>
